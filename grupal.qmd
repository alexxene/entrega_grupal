...
list(Error_Promedio_Por_Casa = error_por_casa, Casa_Mas_Precisa = casa_mas_precisa,Casa_Mas_Desviada = casa_mas_desviada)
```
...
# CALCULAMOS EL REPARTO DE ESCAÑOS PARA CADA PROVINCIA CON LA LEY D'HONT
...
# Ver los resultados
resultados_todos
# Si solo queremos los resultados de Madrid
resultados_todos |> 
