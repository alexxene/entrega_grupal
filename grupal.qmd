...
[Seguimos con los datos electorales]{style="color:#A259FA;"}
...
ggplot(correlacion, aes(x = reorder(siglas, correlacion), y = correlacion)) +
  geom_col(fill = "#B485EC") +
  labs(
    title = "Correlación entre participación y votos por partido",
    x = "Partido",
    y = "Correlación"
  )+
  theme_minimal(base_family = "Rockwell")  #poner una leyenda con la explicación de cor positiva y negativa y lo que significan con relacion a los datos y el enunciado
...
ggplot(relacion_censo_votos, aes(x = censo, y = Total_votos)) +
  ...
  geom_smooth(method = "lm", color = "#1E96C6", se = FALSE) +
  labs(
